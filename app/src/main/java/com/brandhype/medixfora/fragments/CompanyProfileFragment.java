...
public class CompanyProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cf_title = (TextView) rootView.findViewById(R.id.cf_title);
        cf_title.setText("");
        cf= (TextView) rootView.findViewById(R.id.cf);
    ...
    public void onResume() {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_company_profile);
    ...
    private void getContentFromServer()
    {
        ...
        String url = NetworkIOConstant.CS_APIUrls.BASE_URL + "static_pages/details/?apitoken="+token+"&id="+9;
                ...
                try {
                    ...
                    if (api_action_success.equals("1")  && api_syntax_success.equals("1"))
                    {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            cf_title.setText(Html.fromHtml(page_title,Html.FROM_HTML_MODE_COMPACT));
                            cf.setText(Html.fromHtml(page_content, Html.FROM_HTML_MODE_COMPACT));
                        } else {
                            cf_title.setText(Html.fromHtml(page_title));
                            cf.setText(Html.fromHtml(page_content));
                        }
                    }
                    else
                    {
