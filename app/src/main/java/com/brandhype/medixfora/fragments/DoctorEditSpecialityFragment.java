 ...
 */
public class DoctorEditSpecialityFragment extends Fragment  {
    ...
    List<GeneralItem> speciality_list = new ArrayList<>();
    ...
    String doctor_specialities[];

    public DoctorEditSpecialityFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_doctor_edit_speciality, container, false);
        context=getActivity();
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    if (api_action_success.equals("1")  && api_syntax_success.equals("1")) {
                        ...
                        Log.d("@  existing spcl count:",""+doctor_specialities.length);
                        ...
                        for (int i = 0; i < data_arr.length(); i++) {
                            ...
                            if (is_active.equals("Y") || is_active.equals("y")) {
                                ...
                                for(int j=0;j<doctor_specialities.length;j++)
                                {
                                    if (id.equals(doctor_specialities[j]))
                                    {
                                        navItem.setSelected(true);
                                        Log.d("@ matched speciality:",speciality_name);
                                    }
                        ...
                        mAdapter = new HospitalSpecilaityListAdapter(speciality_list);
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    if (api_action_success.equals("1")  && api_syntax_success.equals("1") )
                    {
                        ...
                        Log.d("@ Doctor info:"," name :"+ doctor_name+" image url:  "+doctor_profile_image_path+ " sp id:"+sp_id);

                        doctor_specialities=sp_id.split(",");
    ...
    private void updateDoctorSpeciality(String sp_id)
    {
        AppPreferences pref;
        JSONObject doctor;
        String doctor_id="0";
        ...
        String token= NetworkIOConstant.CS_Token.TOKEN;
        //http://brandhypedigital.in/demo/medixfora/restapi/doctor/get_doctor_details/apitoken/1edc0ae98198866510bce219d5115b72/doctorID/2191
        String url = NetworkIOConstant.CS_APIUrls.BASE_URL + "doctor/update_doctor_speciality";
        ...
        postDataParams.put("sp_id", sp_id);
        ...
        Log.d("@ hitting  at : ","update speciality: "+ url);
        Log.d("@ uploaddoc params ", "update speciality: "+ postJson.toString());
                ...
                try {
                    ...
                    if (api_action_success.equals("1")  && api_syntax_success.equals("1") )
                    {
                        ((MainActivityDoctor)context).runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(context, "Updating Speciality Completed", Toast.LENGTH_SHORT).show();
                                Log.d("Updating", "Updating speciality Completed");
                                //---------------------------------------------------------------------
                            }
                        });//runonui
