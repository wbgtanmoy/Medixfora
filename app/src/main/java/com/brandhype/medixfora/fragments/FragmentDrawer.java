...
import com.brandhype.medixfora.adpaters.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name.setText(sharedPreferences1.getString(LoginPreferences.first_name, "")) ;
        eml.setText(sharedPreferences1.getString(LoginPreferences.email, "")) ;

        patient_profile_pic=(ImageView) layout.findViewById(R.id.patient_profile_pic);
        AppPreferences pref;
        JSONObject patient;
